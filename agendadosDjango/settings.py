"""
Django settings for agendadosDjango project.
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("CLOUD_SQL_NAME", "postgres"),
        "USER": os.getenv("CLOUD_SQL_USERNAME", "postgres"),
        "PASSWORD": os.getenv("CLOUD_SQL_PASSWORD", "postgres"),
